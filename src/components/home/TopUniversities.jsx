...
function TopUniversities() {
  ...
  return (
    <section className="py-16 sm:py-20 bg-[var(--primary)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-10 relative">
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-8 sm:mb-10">
          ...
          <button className="w-fit px-5 py-2 text-sm font-semibold text-white rounded-full bg-[var(--secondary)] hover:opacity-90 transition">
            View All
          </button>
        </div>
        ...
        <button
          onClick={() => scroll("left")}
          className="hidden md:flex absolute left-2 top-1/2 -translate-y-1/2 z-10 bg-white border border-gray-200 p-3 rounded-full shadow-md hover:bg-[var(--primary-light)] transition"
        >
        ...
        <button
          ...
          className="hidden md:flex absolute right-2 md:right-0 top-1/2 -translate-y-1/2 z-20 bg-white border border-gray-200 p-3 rounded-full shadow-md hover:bg-[var(--primary-light)] transition"
        >
          ...
          {universities.map((uni, i) => (
            ...
            >
              ...
              <div className="p-4 sm:p-5">
                ...
                <button className="
                  mt-5 w-full py-2 rounded-full text-xs font-semibold
                  bg-[var(--secondary)] text-white
                  border border-transparent
                  hover:bg-white hover:text-[var(--secondary)] hover:border-[var(--secondary)]
